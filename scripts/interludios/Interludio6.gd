...
@export_multiline var texto_historia: String = "Estamos en la capital de Gestokia del sur pero algo no pinta bien...Esperen, es el SK-X, la leyenda era cierta. CUIDADO!!!"
@export_file("*.tscn") var siguiente_nivel: String = "res://scenes/levels/Level6.tscn"
